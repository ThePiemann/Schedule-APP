            ...
            if (rawData) {
                ...
                slot.innerHTML = `
                    <div style="background-color: ${color};" class="print-event-card p-1.5 flex flex-col justify-center h-full">
                        ...
                        ${data.location ? `<div class="text-[10px] mt-2 font-bold text-gray-700 break-words leading-tight bg-white/30 rounded px-1 py-0.5 inline-block mx-auto">${data.location}</div>` : ''}
                    </div>
                `;
            }
